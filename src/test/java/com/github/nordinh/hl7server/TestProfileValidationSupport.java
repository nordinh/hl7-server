...
public class TestProfileValidationSupport implements IValidationSupport {
    ...
    private static final org.slf4j.Logger ourLog = org.slf4j.LoggerFactory.getLogger(org.hl7.fhir.dstu3.hapi.validation.DefaultProfileValidationSupport.class);
    ...
    private void loadCodeSystems(FhirContext theContext, Map<String, CodeSystem> theCodeSystems, Map<String, ValueSet> theValueSets, String theClasspath) {
        ...
        InputStream inputStream = org.hl7.fhir.dstu3.hapi.validation.DefaultProfileValidationSupport.class.getResourceAsStream(theClasspath);
    ...
    private void loadStructureDefinitions(FhirContext theContext, Map<String, StructureDefinition> theCodeSystems, String theClasspath) {
        ...
        InputStream valuesetText = org.hl7.fhir.dstu3.hapi.validation.DefaultProfileValidationSupport.class.getResourceAsStream(theClasspath);
    ...
    private Map<String, StructureDefinition> provideStructureDefinitionMap(FhirContext theContext) {
        ...
        if (structureDefinitions == null) {
            ...
            InputStream valuesetText = org.hl7.fhir.dstu3.hapi.validation.DefaultProfileValidationSupport.class.getResourceAsStream("/profiles/hd-patient.StructureDefinition.xml");
            InputStreamReader reader = new InputStreamReader(valuesetText, Charsets.UTF_8);
